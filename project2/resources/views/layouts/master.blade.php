...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{asset('template/backend/dist/css/style.min.css')}}" rel="stylesheet">
    <!-- Dashboard 1 Page CSS -->
    <link href="{{asset('template/backend/dist/css/pages/dashboard1.css')}}" rel="stylesheet">
...
<![endif]-->
    <link href="{{asset('template/assets/node_modules/footable/css/footable.bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('template/backend/dist/css/pages/footable-page.css')}}" rel="stylesheet">
    <link href="{{asset('template/backend/dist/css/pages/other-pages.css')}}" rel="stylesheet">
    <link type="text/css" rel="stylesheet" href="{{asset('template/assets/node_modules/jsgrid/jsgrid.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('template/assets/node_modules/jsgrid/jsgrid-theme.min.css')}}">
</head>
...
<body class="skin-blue fixed-layout">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="{{asset('template/assets/images/big/img1.jpg')}}" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="{{asset('template/assets/images/big/img2.jpg')}}" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="{{asset('template/assets/images/big/img3.jpg')}}" alt="Third slide"></div>
                                                </div>
                                            </div>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a href="/dashboard" aria-expanded="false"><i class="icon-home"></i><span class="hide-menu">Dashboard </span></a></li>
                        <li> <a href="/biodata" aria-expanded="false"><i class="icon-user"></i><span class="hide-menu">Personal Data </span></a></li>
                    </ul>
                </nav>
    ...
    <script src="{{asset('template/backend/dist/js/perfect-scrollbar.jquery.min.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('template/backend/dist/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('template/backend/dist/js/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('template/backend/dist/js/custom.min.js')}}"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    ...
    <!-- Chart JS -->
    <!-- <script src="{{asset('template/backend/dist/js/dashboard1.js')}}"></script> -->
    <script src="{{asset('template/assets/node_modules/toast-master/js/jquery.toast.js')}}"></script>
